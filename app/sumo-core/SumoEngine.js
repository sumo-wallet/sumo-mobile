...
import TokenListController from '../sumo-controller/assets/TokenListController';
...
import TokensController from '../sumo-controller/assets/TokensController';
...
class SumoEngine {
  ...
  constructor(initialState = {}) {
    if (!SumoEngine.instance) {
      ...
      this.configureControllersOnNetworkChange();
      this.startPolling();
      SumoEngine.instance = this;
    }
    return SumoEngine.instance;
  }

  startPolling() {
    console.log('SumoEngine: startPolling');
    const {
      // CollectibleDetectionController,
      // TokenDetectionController,
      TokenListController,
  ...
  configureControllersOnNetworkChange() {
    console.log('SumoEngine: configureControllersOnNetworkChange');
    // const {
    //   AccountTrackerController,
    //   AssetsContractController,
    //   TokenDetectionController,
...
export default {
  ...
  get state() {
    console.log('SumoEngine: get state');
    const {
      // AccountTrackerController,
      // AddressBookController,
      // AssetsContractController,
  ...
  getTotalFiatAccountBalance() {
    console.log('SumoEngine: getTotalFiatAccountBalance');
    return instance.getTotalFiatAccountBalance();
  },
  hasFunds() {
    console.log('SumoEngine: hasFunds');
  ...
  init(state: {} | undefined) {
    console.log('SumoEngine: init');
    instance = new SumoEngine(state);
