...
export const InfoRow = ({ title, value }: { title: string; value: string }) => {
  return (
    ...
    >
      <Text style={Fonts.t({ s: 14, c: Colors.white[2], t: 2, r: 40 })}>
        {title}
      </Text>
      <Text style={Fonts.t({ s: 14, c: Colors.grayscale[60], t: 2 })}>
        {value}
      </Text>
    </View>
  );
      ...
      <ScrollView style={Style.s({ flex: 1 })}>
        <View style={Style.s({ items: 'center', self: 'center', mt: 20 })}>
          <FastImage
            ...
            source={dapp?.image}
          />
          <Text style={Fonts.t({ s: 18, w: '500', c: Colors.white[2], t: 12 })}>
            {dapp?.name}
          </Text>
        </View>
        <View
        ...
        <View style={Style.s({ px: 16, mt: 24 })}>
          ...
          >
            ...
            <View style={Style.s({ bg: Colors.grayscale[80], h: 1 })} />
