...
export class NetworkList extends PureComponent {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <View style={Style.s({ size: 32, cen: true })}>{selected}</View>
        </View>
      </TouchableOpacity>
    );
  };
  ...
  renderMainnet() {
    ...
    return (
      <View style={[]}>
        <TouchableOpacity
          style={[styles.networkContainer, styles.mainnet]}
          key={`network-mainnet`}
    ...
    return (
      ...
      >
        <ScrollView
          ...
          testID={NETWORK_SCROLL_ID}
          contentContainerStyle={Style.s({ pt: 12 })}
        >
          {this.renderMainnet()}
