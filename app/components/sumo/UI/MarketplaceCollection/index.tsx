...
import { ModelCollection } from 'app/types';
...
export interface MarketNFtCollectionModel {
...
export const NftCollectionScreen = React.memo(() => {
  ...
  const {
    collection,
  }: { collection: ModelCollection } = useNavigatorParams();
    ...
    <View style={styles.headerContainer}>
      ...
      <View style={styles.collectionInfoContainer}>
        <FastImage
          ...
          source={{
            uri: collection.banner_image_url,
          }}
        />

        <View style={styles.nameContainer}>
          <Text style={styles.collectionNameTitle}>{collection.name}</Text>
        </View>
